...
def run_inference(image_array, file_weights, num_classes=5, file_stats_json="image_stats.json"):
    ...
    oil_spill_seg_model.load_state_dict(torch.load(file_weights))
    ...
    image_padder = ImagePadder("/home/abhishek/Desktop/RUG/htsm_masterwork/oil-spill-detection-dataset/train/images")
